...
class Router {
    ...
    class RouterTableEntry {
        ...
        public:
            RouterTableEntry(const uint32_t route_prefix, const uint8_t prefix_length, const std::optional<Address> next_hop, const size_t interface_num) : _route_prefix(route_prefix), _prefix_length(prefix_length), _next_hop(next_hop), _interface_num(interface_num) {}
    };
    std::list<RouterTableEntry> _router_table{};
